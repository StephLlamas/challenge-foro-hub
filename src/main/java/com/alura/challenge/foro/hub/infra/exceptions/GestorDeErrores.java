package com.alura.challenge.foro.hub.infra.exceptions;

import com.alura.challenge.foro.hub.domain.ValidacionException;
...
public class GestorDeErrores {
    ...
    public ResponseEntity gestionarError400(MethodArgumentNotValidException ex) {
        var errors = ex.getFieldErrors().stream().map(DatosErrorValidacion::new).toList();
